                    ...
                    <?php if($numb == 1): ?>
                      ...
                      <div class="col-xs-4 col-sm-4">
                        <div class="text-center">
                          <img src="<?php echo e(get_image_url($row->url)); ?>"  alt="<?php echo e(basename( $row->url )); ?>" />
                        </div>
                      </div>
    ...
    <div class="col-xs-12 col-sm-7 col-md-7">
      <div class="model__quick_view_product_info">
        ...
        <div class="model__quick_view_product_price">
          ...
          <span class="offer-price"><?php echo price_html( $single_product_details['post_regular_price'] ); ?></span>
          <?php endif; ?>
          <span class="solid-price"><?php echo price_html( $single_product_details['post_price'] ); ?></span>
