...
<div class="box box-info">
  <div class="box-header">
    <h3 class="box-title"><?php echo trans('admin.colors_list'); ?></h3>
    <div class="box-tools pull-right">
      <button data-toggle="modal" data-target="#addDynamicColors" class="btn btn-primary custom-event-colors" type="button"><?php echo trans('admin.add_new_color'); ?></button>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog add-colors-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p class="no-margin top-title-color"><b><?php echo trans('admin.create_new_product_color'); ?></b></p>
      </div>
