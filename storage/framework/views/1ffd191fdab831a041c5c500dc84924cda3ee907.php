        ...
        <table class="table table-bordered table-striped admin-data-table">
          ...
          <tbody>
            <?php if(count($sizes_list_data)>0): ?>
              <?php $__currentLoopData = $sizes_list_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
