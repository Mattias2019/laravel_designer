<?php if(Request::is('admin/product/categories/customlist')): ?>
...
<div class="row">
  <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
    <h4><?php echo trans('Categories List'); ?></h4>
  </div>
  <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
    <div class="pull-right">
      <button data-toggle="modal" data-target="#addDynamicCategories" class="btn btn-primary custom-event" type="button"><?php echo trans('Add New CustomCategory'); ?></button>
    </div>  
  </div>
</div>
  ...
  <div class="modal-dialog add-cat-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p class="no-margin"><b><?php echo trans('Add New CustomCategory'); ?></b></p>
      </div>
      <div class="modal-body">
        <div class="custom-model-row">
          ...
          <!-- 900 -->
          <div class="custom-input-element"><input type="hidden" name="inputCatFb" id="inputCatFb" value="1"></div>
          <div class="custom-input-group">
            ...
            <div class="custom-input-element">
              <select name="cat_parent" id="cat_parent" class="form-control select2" style="width: 100%;">
                ...
                <?php if(count($only_cat_name)>0): ?>
                  <?php $__currentLoopData = $only_cat_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger attachtopost create-cat"><?php echo trans('Create CustomCategory'); ?></button>
        <button type="button" class="btn btn-danger attachtopost" data-dismiss="modal"><?php echo trans('admin.close'); ?></button>
      </div>
    </div>
  </div>
</div>
        ...
        <table class="table table-striped table-bordered dt-responsive nowrap admin-data-table" cellspacing="0" width="100%">
          ...
          <tbody>
            <?php if(count($cat_list_data)>0): ?>
              <?php $__currentLoopData = $cat_list_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
